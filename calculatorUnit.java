...
public class CalculatorUnit implements Calculator {
	...
	public void save() {
		...
		try {
			// opens file
			FileOutputStream saveFile = new FileOutputStream("SavedObj.txt");

                    try ( // Create an ObjectOutputStream to put objects into save file.
	...
	public void load() {
		...
		try {
			// Open file .
			FileInputStream loadfile = new FileInputStream("SavedObj.txt");

                    try ( // Create an ObjectInputStream to get objects from load file.
