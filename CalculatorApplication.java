//link:https://github.com/Ziyadelbanna/Object-oriented/tree/master/src
...
public class CalculatorApplication extends JFrame {
	...
	private void initialize() {
		...
		btnNewButton_4.addActionListener((ActionEvent arg0) -> {
                    String string;
                    if (textField.getText().equals(result) || textField.getText().equals("There is no next operation.")
                            || textField.getText().equals("No previous operation.")
                            || textField.getText().equals("There is no memory.")) {
		...
		btnNewButton_5.addActionListener((ActionEvent arg0) -> {
                    String string;
                    if (textField.getText().equals(result) || textField.getText().equals("There is no next operation.")
                            || textField.getText().equals("No previous operation.")
                            || textField.getText().equals("There is no memory.")) {
		...
		btnNewButton_6.addActionListener((ActionEvent arg0) -> {
                    String string;
                    if (textField.getText().equals(result) || textField.getText().equals("There is no next operation.")
                            || textField.getText().equals("No previous operation.")
                            || textField.getText().equals("There is no memory.")) {
		...
		btnNewButton_7.addActionListener((ActionEvent arg0) -> {
                    String string;
                    if (textField.getText().equals(result) || textField.getText().equals("There is no next operation.")
                            || textField.getText().equals("No previous operation.")
                            || textField.getText().equals("There is no memory.")) {
		...
		btnNewButton_8.addActionListener((ActionEvent arg0) -> {
                    String string;
                    if (textField.getText().equals(result) || textField.getText().equals("There is no next operation.")
                            || textField.getText().equals("No previous operation.")
                            || textField.getText().equals("There is no memory.")) {
		...
		btnNewButton_9.addActionListener((ActionEvent arg0) -> {
                    String string;
		...
		btnNewButton_10.addActionListener((ActionEvent arg0) -> {
                    save = true;
                    calc.save();
                });
		btnNewButton_10.setForeground(Color.BLACK);
		btnNewButton_10.setFont(new Font("Geneva", Font.BOLD | Font.ITALIC, 20));
		btnNewButton_10.setBounds(297, 86, 110, 79);
		frame.getContentPane().add(btnNewButton_10);

		JButton btnNewButton_11 = new JButton("LOAD");
		btnNewButton_11.addActionListener((ActionEvent arg0) -> {
                    String current;
                    calc.load();
		...
		btnNewButton_11.setFont(new Font("Geneva", Font.BOLD | Font.ITALIC, 20));
		btnNewButton_11.setBounds(406, 86, 107, 79);
		frame.getContentPane().add(btnNewButton_11);

		JButton btnNewButton_12 = new JButton("NEXT");
		btnNewButton_12.addActionListener((ActionEvent arg0) -> {
                    String current;
                    current = calc.next();
                    if (current == null) {
		...
		btnNewButton_12.setFont(new Font("Geneva", Font.BOLD | Font.ITALIC, 20));
		btnNewButton_12.setBounds(297, 153, 110, 85);
		frame.getContentPane().add(btnNewButton_12);

		JButton btnNewButton_13 = new JButton("PREV");
		btnNewButton_13.addActionListener((ActionEvent e) -> {
                    String current;
                    current = calc.prev();
                    if (current == null) {
		...
		btnNewButton_13.setFont(new Font("Geneva", Font.BOLD | Font.ITALIC, 20));
		btnNewButton_13.setBounds(406, 153, 107, 85);
		frame.getContentPane().add(btnNewButton_13);

		JButton btnNewButton_14 = new JButton("+");
		btnNewButton_14.addActionListener((ActionEvent e) -> {
		...
		btnNewButton_15.addActionListener((ActionEvent e) -> {
                    String string = textField.getText();
                    textField.setText(string + '-');
                });
		...
		btnNewButton_16.addActionListener((ActionEvent arg0) -> {
                    String string = textField.getText();
                    textField.setText(string + '*');
                });
		...
		btnNewButton_18.addActionListener((ActionEvent e) -> {
                    String string = textField.getText();
		...
		btnNewButton_19.addActionListener((ActionEvent e) -> {
                    String string = new String();
                    textField.setText(string);
                });
		btnNewButton_19.setFont(new Font("Geneva", Font.BOLD, 22));
